...
#  CYTHON_FLAGS
#
# Source file properties that affect the build process are
#
#  CYTHON_IS_CXX
#
...
function( cython_add_module _name )
  ...
  Python3_add_module( ${_name} ${generated_file} ${other_module_sources} )
  if ( APPLE )
    set_target_properties( ${_name} PROPERTIES LINK_FLAGS "-undefined dynamic_lookup" )
  else ()
    target_link_libraries( ${_name} Python3::Module )
  endif ()
endfunction()
...
function( cython_add_standalone_executable _name )
  ...
  foreach ( _file ${cython_arguments_UNPARSED_ARGUMENTS} )
    if ( ${_file} MATCHES ".*\\.py[x]?$" )
      ...
      elseif ( NOT "${_file}" STREQUAL "${cython_arguments_MAIN_MODULE}" )
        set( Python3_MODULE_${_file_we}_static_BUILD_SHARED OFF )
  ...
  target_link_libraries( ${_name} Python3::Module ${pyx_module_libs} )
endfunction()
