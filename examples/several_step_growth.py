...
axon_params = {
    ...
    "use_critical_resource": False, # for the cst extension model no use of critical resource
...
if __name__ =='__main__':
    ...
    ds.set_object_status(gids, axon_params=vp_axon, dendrites_params=vp_dend)
    ...
    #    ds.set_object_status(gids, axon_params=lat_params, dendrites_params=dlat_params)
