...
IF(WIN32)
  ...
  IF (MSVC)
    ...
    FIND_LIBRARY(GEOS_LIBRARY NAMES geos geos_c_i geos_c NAMES_PER_DIR PATHS
      "$ENV{LIB_DIR}/lib"
      $ENV{LIB}
      )
    FIND_LIBRARY(GEOS_C_LIBRARY NAMES geos_c_i geos_c PATHS
      "$ENV{LIB_DIR}/lib"
      $ENV{LIB}
      )
    # IF ((NOT "${GEOS_C_LIBRARY}" STREQUAL "") AND (NOT "${GEOS_C_LIBRARY}" STREQUAL "${GEOS_LIBRARY}"))
		# SET(GEOS_LIBRARY "${GEOS_LIBRARY} ${GEOS_C_LIBRARY}")
...
IF (GEOS_FOUND)
   ...
   IF (NOT GEOS_FIND_QUIETLY)
	  ...
	  IF (NOT "${GEOS_C_LIBRARY}" STREQUAL "")
	     MESSAGE(STATUS "Found separate GEOS_C: ${GEOS_C_LIBRARY}")
	  ENDIF ()
