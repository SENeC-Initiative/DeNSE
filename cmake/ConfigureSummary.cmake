...
function( CGROWTH_PRINT_CONFIG_SUMMARY )
  ...
  message( "" )
  message( "Python bindings     : Yes (Python ${Python3_VERSION}: ${PYTHON})" )
  message( "       Includes     : ${Python3_INCLUDE_DIRS}" )
  message( "" )
  if ( CYTHON_FOUND )
  ...
  if ( SUCCESS )
    ...
    if (MSVC)
      message( "  cmake --build . --config ${CMAKE_BUILD_TYPE} --target INSTALL" )
      if ( WITH_DOCS )
        message( "  cmake --build . --config ${CMAKE_BUILD_TYPE} --target doc (to install documentation)" )
      endif ()
    else ()
      message( "  make" )
